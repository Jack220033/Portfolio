...
export default function Accueil() {
    return <>
        <Head>
            ...
            <meta name="description" content="Page du d'acceuil du portfolio  avec plusieur composante de React et avec une Biographie" />

            <meta property="og:title" content="Page d'acceuil portfolio Jacob Arcand" />
            <meta property="og:description" content="Page du d'acceuil du portfolio  avec plusieur composante de React et avec une Biographie" />
